{
  ...
  "views": [
    ...
    },
    {
      ...
      "dimension": "kapitel",
      "breakdown": "titel",
      "filters": {"bund_titel": "true", "taxonomy": "bund"}
    },
    {
      "entity": "dataset",
      "label": "Funktionen",
    ...
    },
    {
      ...
      "label": "Funktionen",
      "name": "default",
      "dimension": "hauptfunktion",
      "breakdown": "oberfunktion",
      "filters": {"taxonomy": "funktionenplan-bund", "level": "1"}
    },
    {
      "entity": "classifier",
      "label": "Funktionen",
      "name": "default",
      "dimension": "oberfunktion",
      "breakdown": "funktion",
      "filters": {"taxonomy": "funktionenplan-bund", "level": "2"}
    },
    {
      "entity": "classifier",
      "label": "Titel",
      ...
      "dimension": "funktion",
      "breakdown": "titel",
      "filters": {"taxonomy": "funktionenplan-bund", "level": "3"}
    },
    {
      "entity": "dataset",
      "label": "Gruppierung",
    ...
    },
    {
      ...
      "label": "Gruppierung",
      "name": "default",
      "dimension": "hauptgruppe",
      "breakdown": "obergruppe",
      "filters": {"taxonomy": "gruppierungsplan-bund", "level": "1"}
    },
    {
      "entity": "classifier",
      "label": "Gruppierung",
      "name": "default",
      "dimension": "obergruppe",
      "breakdown": "gruppe",
      "filters": {"taxonomy": "gruppierungsplan-bund", "level": "2"}
    },
    {
      "entity": "classifier",
      "label": "Titel",
      ...
      "dimension": "gruppe",
      "breakdown": "titel",
      "filters": {"taxonomy": "gruppierungsplan-bund", "level": "3"}
    }
  ]
}
